...
public class ViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                return FragmentList.newInstance(ModelUserInfo.FILTER_AH);
            case 1:
                return FragmentList.newInstance(ModelUserInfo.FILTER_IP);
            case 2:
                return FragmentList.newInstance(ModelUserInfo.FILTER_QZ);
            default:
                break;
        }
        return null;
